...
namespace XBuilder.Options
{
	public class XBuilderOptionsGeneral : DialogPage
	{
		...
		[Category("Supported File Extensions"),
		DisplayName("Effect File Extensions"),
		Description("Comma-separated list of effect file extensions (prefixed by a '.') that you want to load using Content Preview."),
		DefaultValue(".fx")]
		public string EffectExtensions { get; set; }
