...
using FormosatekLtd.ModelViewer;

namespace ModelViewer_UnitTests.MenuItemTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		{
			// Create the package
			IVsPackage package = new ModelViewerPackage() as IVsPackage;
			...
			CommandID menuCommandID = new CommandID(FormosatekLtd.ModelViewer.GuidList.guidModelViewerCmdSet, (int)FormosatekLtd.ModelViewer.PkgCmdIDList.cmdidViewModel);
